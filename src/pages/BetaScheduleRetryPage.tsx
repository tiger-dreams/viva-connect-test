...
export const BetaScheduleRetryPage = () => {
  ...
  const scheduleRetry = async () => {
    try {
      ...
      console.log('[Beta Schedule Retry] Scheduling retry for SID:', sid);

      const response = await fetch('/api/schedule-retry', {
        method: 'POST',
      ...
      console.log('[Beta Schedule Retry] API response:', result);
      ...
      console.error('[Beta Schedule Retry] Error:', err);
...
export default BetaScheduleRetryPage;
