...
export const BetaAgentCallTrigger = () => {
  ...
  const initiateAgentCall = async () => {
    ...
    try {
      ...
      console.log('[BetaAgentCallTrigger] API response:', result);
      ...
      if (result.success) {
        ...
        setTimeout(() => {
          if (liff?.isInClient()) {
            console.log('[BetaAgentCallTrigger] Auto-closing LIFF window');
            liff.closeWindow();
          }
        }, 2000);
      } else {
      ...
      console.error('[BetaAgentCallTrigger] Error:', err);
...
export default BetaAgentCallTrigger;
